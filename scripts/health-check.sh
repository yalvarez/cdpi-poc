...
check "geo-location"       "docker compose ps geo-location | grep -q 'running\|Up'"
...
check "Countries endpoint" "curl -sf http://localhost:5000/countries | grep -qi 'statusCode\|countriesVerificationCode'"
