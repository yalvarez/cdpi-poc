...
export ENV_TEMPLATE ENV_FILE MASTER_TABLE \
  ...
  PLATFORM_ADMIN_INITIAL_PASSWORD PLATFORM_SEED JWT_SECRET NEXTAUTH_SECRET API_ENDPOINT VPS_IP \
  PLATFORM_WEB_URL FRONT_END_URL STUDIO_URL ENABLE_CORS_IP_LIST APP_PROTOCOL MINIO_ROOT_PASSWORD \
  AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY JWT_TOKEN_SECRET PLATFORM_ADMIN_EMAIL \
  PUBLIC_PLATFORM_SUPPORT_EMAIL CRYPTO_PRIVATE_KEY PUBLIC_HOST PROTOCOL
